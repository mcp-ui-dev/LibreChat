...
describe('mcpUIResourcePlugin', () => {
  ...
  describe('single resource markers', () => {
    it('should replace single UI resource marker with mcp-ui-resource node', () => {
      const tree = createTree([createTextNode(`Here is a resource ${UI_RESOURCE_MARKER}ui0`)]);
      processTree(tree);
    ...
    it('should handle multiple single resource markers', () => {
      const tree = createTree([
        createTextNode(`First ${UI_RESOURCE_MARKER}ui0 and second ${UI_RESOURCE_MARKER}ui1`),
      ]);
      processTree(tree);
    ...
    it('should handle large index numbers', () => {
      const tree = createTree([createTextNode(`Resource ${UI_RESOURCE_MARKER}ui42`)]);
      processTree(tree);
  ...
  describe('carousel markers', () => {
    it('should replace carousel marker with mcp-ui-carousel node', () => {
      const tree = createTree([createTextNode(`Carousel ${UI_RESOURCE_MARKER}ui0,1,2`)]);
      processTree(tree);
    ...
    it('should handle large index numbers in carousel', () => {
      const tree = createTree([createTextNode(`${UI_RESOURCE_MARKER}ui100,200,300`)]);
      processTree(tree);
  ...
  describe('mixed content', () => {
    it('should handle text before and after markers', () => {
      const tree = createTree([
        createTextNode(`Before ${UI_RESOURCE_MARKER}ui0 middle ${UI_RESOURCE_MARKER}ui1,2 after`),
      ]);
      processTree(tree);
    ...
    it('should handle marker at start of text', () => {
      const tree = createTree([createTextNode(`${UI_RESOURCE_MARKER}ui0 after`)]);
      processTree(tree);
    ...
    it('should handle marker at end of text', () => {
      const tree = createTree([createTextNode(`Before ${UI_RESOURCE_MARKER}ui0`)]);
      processTree(tree);
    ...
    it('should handle consecutive markers', () => {
      const tree = createTree([createTextNode(`${UI_RESOURCE_MARKER}ui0${UI_RESOURCE_MARKER}ui1`)]);
      processTree(tree);
    ...
    it('should handle nested structures', () => {
      const tree = {
        ...
        children: [
          {
            type: 'paragraph',
            children: [createTextNode(`Text with ${UI_RESOURCE_MARKER}ui0`)],
          },
        ],
      } as Node;
  ...
  describe('pattern validation', () => {
    it('should not match invalid patterns', () => {
      const invalidPatterns = [
        `${UI_RESOURCE_MARKER}ui`,
        `${UI_RESOURCE_MARKER}uiabc`,
        `${UI_RESOURCE_MARKER}ui-1`,
        `${UI_RESOURCE_MARKER}ui,1`,
        `ui0`, // missing marker
      ];
    ...
    it('should handle partial matches correctly', () => {
      ...
      const tree1 = createTree([createTextNode(`${UI_RESOURCE_MARKER}ui1.2`)]);
      processTree(tree1);
      ...
      const tree2 = createTree([createTextNode(`${UI_RESOURCE_MARKER}ui1,`)]);
      processTree(tree2);
